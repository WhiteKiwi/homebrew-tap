class Locron < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.2.0/locron-v0.2.0-aarch64-apple-darwin.tar.gz"
      sha256 "de062edd19f66539dd4d7c2177a3a4ed699517feecbc84afd80f36037df34469"
    else
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.2.0/locron-v0.2.0-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.2.0/locron-v0.2.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "1ac015d42a1885aefdfd64e886bf4fc0705d1cdf12c1e1e51a6e19ab0d1b0af5"
    else
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.2.0/locron-v0.2.0-x86_64-unknown-linux-gnu.tar.gz"
