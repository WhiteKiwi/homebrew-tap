class Locron < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.5.0/locron-v0.5.0-aarch64-apple-darwin.tar.gz"
      sha256 "10ec35f3cd83f83d2c1295037a4b9cfb5f18640f5240dac11b474ead83578b0f"
    else
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.5.0/locron-v0.5.0-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.5.0/locron-v0.5.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "de61797a81d22e42eb43ce5271cae019b00bd209ed1b109bf486cb10fc7bb4d1"
    else
      url "https://github.com/WhiteKiwi/locron/releases/download/v0.5.0/locron-v0.5.0-x86_64-unknown-linux-gnu.tar.gz"
